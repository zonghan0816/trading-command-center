...
### 🎭 4 時段 × 4 個不同節目（產品 DNA、像迷你電視台）

⚠️ **不是「阿明小美換衣服」、是 4 個不同節目共用 TDT 頻道**：

| 時段 | 節目概念 | 場景 | 姿勢 | 角色 |
|---|---|---|---|---|
| 6AM-12PM | 早晨節目 | 早晨棚 | 站著 | 一組（可能 A 男 + A 女）|
| 12PM-6PM | 下午茶節目 | 咖啡廳 | 坐著喝茶配蛋糕 | 另一組 or 同 A 組 |
| **6PM-12AM** | **黃金主節目 TDT** | **現有棚景** | **站立** | **阿明 + 小美** |
| 12AM-6AM | 深夜節目 | 臥室 | 坐 2 張床上 | 另一組 |

**角色配置彈性**（最少 4 人共用、最多 8 人獨立、混合也行）：

- 阿明小美 = **黃金時段主節目主持人**
- 其他時段是「TDT 頻道下的姊妹節目」、用不同主持人

→ 觀眾隨時切進來看到「啊現在播 XX 節目」、像迷你電視台、不是「兩個 AI 永遠在聊」。
→ **角色像活人**是專案 DNA、不是錦上添花。

**未來擴充**（Phase 5+）：4 季 × 4 時段 = 16 場景、加天氣可達 64 變化。MVP 不做、但架構保留 expandability。
