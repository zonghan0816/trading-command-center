...
### 🎭 4 時段 × 4 組角色換裝（VTuber 邏輯、產品 DNA）

| 時段 | 氛圍 | 角色狀態 |
|---|---|---|
| 6AM-12PM | fresh | 上班族裝、精神好、咖啡杯 |
| 12PM-6PM | energetic | 隨意休閒、有梗、活躍 |
| 6PM-12AM | heated | 主持人正裝、激辯、火力全開 |
| 12AM-6AM | sleepy | 睡衣、披毯、語氣慢、累 |

→ 阿明 4 套 + 小美 4 套 = 24H 內觀眾看到 8 個造型、像 VTuber 換裝、不同時段像「不同集數」、留人率高。
